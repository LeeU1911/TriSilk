...
public class MaSanPhamResourceIntTest {
    ...
    public void checkProductIdIsRequired() throws Exception {
        int databaseSizeBeforeTest = maSanPhamRepository.findAll().size();
        // set the field null
        maSanPham.setProductId(null);

        // Create the MaSanPham, which fails.
        ...
        List<MaSanPham> maSanPhamList = maSanPhamRepository.findAll();
        assertThat(maSanPhamList).hasSize(databaseSizeBeforeTest);
    }
