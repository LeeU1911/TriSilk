...
public class SanPhamResourceIntTest {
    ...
    private static final Float DEFAULT_TRONG_LUONG = 1F;
    private static final Float UPDATED_TRONG_LUONG = 2F;
    ...
    private static final Float DEFAULT_MET_CON_LAI = 1F;
    private static final Float UPDATED_MET_CON_LAI = 2F;
    ...
    public void createSanPham() throws Exception {
        ...
        assertThat(testSanPham.getSoMet()).isEqualTo(DEFAULT_SO_MET);
    ...
    public void checkNgayTaoIsRequired() throws Exception {
        int databaseSizeBeforeTest = sanPhamRepository.findAll().size();
        // set the field null
        sanPham.setNgayTao(null);

        // Create the SanPham, which fails.
        ...
        List<SanPham> sanPhamList = sanPhamRepository.findAll();
        assertThat(sanPhamList).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void getAllSanPhams() throws Exception {
        ...
        restSanPhamMockMvc.perform(get("/api/san-phams?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].trongLuong").value(hasItem(DEFAULT_TRONG_LUONG.doubleValue())))
            ...
            .andExpect(jsonPath("$.[*].metConLai").value(hasItem(DEFAULT_MET_CON_LAI.doubleValue())));
    }
    ...
    public void getSanPham() throws Exception {
        ...
        restSanPhamMockMvc.perform(get("/api/san-phams/{id}", sanPham.getId()))
            ...
            .andExpect(jsonPath("$.trongLuong").value(DEFAULT_TRONG_LUONG.doubleValue()))
            ...
            .andExpect(jsonPath("$.metConLai").value(DEFAULT_MET_CON_LAI.doubleValue()));
    }
    ...
    public void updateSanPham() throws Exception {
        ...
        assertThat(testSanPham.getSoMet()).isEqualTo(UPDATED_SO_MET);
