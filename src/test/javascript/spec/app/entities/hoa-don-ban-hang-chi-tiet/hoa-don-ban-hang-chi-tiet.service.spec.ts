...
describe('Service Tests', () => {
    ...
    describe('HoaDonBanHangChiTiet Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(HoaDonBanHangChiTietService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/hoa-don-ban-hang-chi-tiets';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return HoaDonBanHangChiTiet', () => {
