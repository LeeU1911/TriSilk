...
currentAccount: any;
    ...
    loadAll() {
        this.hoaDonBanHangChiTietService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<HoaDonBanHangChiTiet[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/hoa-don-ban-hang-chi-tiet'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/hoa-don-ban-hang-chi-tiet', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    private onSuccess(data, headers) {
        ...
        this.hoaDonBanHangChiTiets = data;
    }
