...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.dinogroup.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.dinogroup.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
            cm.createCache(com.dinogroup.domain.User.class.getName(), jcacheConfiguration);
            cm.createCache(com.dinogroup.domain.Authority.class.getName(), jcacheConfiguration);
            cm.createCache(com.dinogroup.domain.User.class.getName() + ".authorities", jcacheConfiguration);
