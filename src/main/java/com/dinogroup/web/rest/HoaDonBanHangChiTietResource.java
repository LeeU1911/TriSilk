...
public class HoaDonBanHangChiTietResource {
    ...
    @Timed
    public ResponseEntity<HoaDonBanHangChiTiet> createHoaDonBanHangChiTiet(@RequestBody HoaDonBanHangChiTiet hoaDonBanHangChiTiet) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<HoaDonBanHangChiTiet> updateHoaDonBanHangChiTiet(@RequestBody HoaDonBanHangChiTiet hoaDonBanHangChiTiet) throws URISyntaxException {
    ...
    @Timed
    public List<HoaDonBanHangChiTiet> getAllHoaDonBanHangChiTiets() {
        log.debug("REST request to get all HoaDonBanHangChiTiets");
        return hoaDonBanHangChiTietRepository.findAll();
        }
