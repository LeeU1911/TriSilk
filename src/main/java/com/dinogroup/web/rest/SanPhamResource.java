...
public class SanPhamResource {
    ...
    @Timed
    public ResponseEntity<SanPham> createSanPham(@Valid @RequestBody SanPham sanPham) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<SanPham> updateSanPham(@Valid @RequestBody SanPham sanPham) throws URISyntaxException {
