...
public class MaSanPhamResource {
    ...
    @Timed
    public ResponseEntity<MaSanPham> createMaSanPham(@Valid @RequestBody MaSanPham maSanPham) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<MaSanPham> updateMaSanPham(@Valid @RequestBody MaSanPham maSanPham) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<List<MaSanPham>> getAllMaSanPhams(Pageable pageable) {
        log.debug("REST request to get a page of MaSanPhams");
        Page<MaSanPham> page = maSanPhamRepository.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/ma-san-phams");
